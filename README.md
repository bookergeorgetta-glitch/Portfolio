...
<button class="bg-purple-darker border-t-2 rounded-full opacity-75 px-3 py-2 shadow-lg font-serif text-base font-medium text-white"><a href="https://github.com/bookergeorgetta-glitch/Portfolio/blob/main/PersonalProjects">Flights of Fancy</a>a>
</button>
